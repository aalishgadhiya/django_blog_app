...
from .views import IndexPage , All_blog_page,blog_detail_page,All_bloggers_page,blogger_detail_page,Login_page,Register_page,Logout_page,CreateBlogView,AddCommentView,EditComment
